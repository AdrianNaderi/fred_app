...
import '../../../controllers/friends_view_selection_controller.dart';
...
class TopBarSelectionItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final itemState =
        ref.watch(friendsViewSelectionController).viewState[text]!;
    return GestureDetector(
      onTap: () => ref
          .read(friendsViewSelectionController)
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: itemState
              ? CustomColors.brand
              : CustomColors.brand.withOpacity(0),
